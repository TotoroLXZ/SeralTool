...
void MoveButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MoveButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (MoveButton::*)(QString );
...
QT_INIT_METAOBJECT const QMetaObject MoveButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_meta_stringdata_MoveButton.data,
    qt_meta_data_MoveButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
