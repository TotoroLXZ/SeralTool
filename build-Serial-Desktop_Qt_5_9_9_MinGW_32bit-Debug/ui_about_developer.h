...
public:
    ...
    void setupUi(QWidget *about_developer)
    {
        if (about_developer->objectName().isEmpty())
            about_developer->setObjectName(QStringLiteral("about_developer"));
    ...
    {
        about_developer->setWindowTitle(QApplication::translate("about_developer", "Form", Q_NULLPTR));
        label->setText(QApplication::translate("about_developer", "\350\275\257\344\273\266\347\224\261TOTORO\344\270\252\344\272\272\345\210\233\344\275\234-\346\265\213\350\257\225\347\211\210V2\343\200\202\n"
...
"\346\204\237\350\260\242\346\202\250\347\232\204\344\275\277\347\224\250\357\274\201", Q_NULLPTR));
    } // retranslateUi
