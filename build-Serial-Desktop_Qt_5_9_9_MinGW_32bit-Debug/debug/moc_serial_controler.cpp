...
void Serial_Controler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Serial_Controler *_t = static_cast<Serial_Controler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Serial_Controler::*_t)(int );
...
const QMetaObject Serial_Controler::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Serial_Controler.data,
      qt_meta_data_Serial_Controler,  qt_static_metacall, nullptr, nullptr}
};
